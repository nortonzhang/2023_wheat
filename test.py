...
data_path = "E:\\04-design\\2023_wheat\\data\\wheatData_split910"  # todo 修改为数据集根目录

model_path = "checkpoints/efficientnet_b3a_pretrained_2241/efficientnet_b3a_85epochs_accuracy0.97785_weights.pth"  # todo 模型地址
model_name = 'efficientnet_b3a'  # todo 模型名称

# model_path = "checkpoints/resnet50d_pretrained_224/resnet50d_55epochs_accuracy0.97036_weights.pth"  # todo 模型地址
# model_name = 'resnet50d'  # todo 模型名称

# model_path = "checkpoints/vit_tiny_patch16_224_pretrained_224/vit_tiny_patch16_224_89epochs_accuracy0.96383_weights.pth"  # todo 模型地址
# model_name = 'vit_tiny_patch16_224'  # todo 模型名称
...
def test(val_loader, model, params, class_names):
    ...
    # 加上模型名称
    # heat_maps_float_resized = np.zeros((2*class_names, new_size))  # 设置新的大小
    # heat_maps_float_resized[:old_size, :old_size] = heat_maps_float  # 将原始数据复制到新的大小
