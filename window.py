...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        # self.model_path = "E:/04-design/checkpoints/efficientnet_b3a_pretrained_224/efficientnet_b3a_10epochs_accuracy0.99238_weights.pth"  # todo  模型路径
        # self.classes_names = ['根冠腐烂', '健康小麦', '叶锈病']  # todo 类名
        self.model_path = "E:/04-design/checkpoints/efficientnet_b3a_pretrained_224/efficientnet_b3a_8epochs_accuracy0.78417_weights.pth"  # todo  模型路径
        self.classes_names = ['根冠腐烂', '健康小麦', '叶锈病', '小麦蚜虫病', '小麦红蜘蛛病', '小麦白粉病', '小麦孢囊线虫病', '小麦赤霉病', '小麦枯纹病', '小麦茎基腐', '小麦全蚀病']  # todo 类名
        self.img_size = 224  # todo 图片大小
        self.model_name = "efficientnet_b3a"  # todo 模型名称
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        # self.addTab(about_widget, '找到我')   #关于作者界面
        self.setTabIcon(0, QIcon('images/UI/logo.jpg'))
        self.setTabIcon(1, QIcon('images/UI/logo.jpg'))
